...
const ProductsAdd: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <ProgressBar now={passo * 25} label={`${passo}/4`} />

      <div className="d-flex justify-content-between align-items-center mt-4">
        {passos.map((item) => (
          <div key={item.numero} className={`text-center ${item.numero <= passo ? "text-success" : ""}`}>
            <FontAwesomeIcon icon={getIcon(item.numero)} size="2x" />
